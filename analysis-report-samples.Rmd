...
if(params$run == "Reynolds2021_Data-all_seuratObj" ){
      ...
      celltype_cluster_data <- data.frame(
          table(as.character(seurat_object@meta.data[, cell_type])),
      ...
      celltype_colors <- pals::glasbey(length(unique(seurat_object@meta.data[, cell_type])))
      celltype_cluster_data <- data.frame(
          table(as.character(seurat_object@meta.data[, cell_type])),
          "color" = celltype_colors
      )
...
p1 <- VlnPlot(seurat_object, features = c("nFeature_RNA", "nCount_RNA", "percent.mt"), group.by = "predicted.id.Cell_type_nicknames", cols = celltype_colors)
...
VlnPlot(seurat_object, features = c("nFeature_RNA", "nCount_RNA", "percent.mt"), group.by = "orig.ident")
FeatureScatter(seurat_object, feature1 = "nCount_RNA", feature2 = "percent.mt", group.by = "orig.ident")
...
p1 <- DimPlot(seurat_object, reduction = "umap", group.by = cell_type, cols = celltype_cluster_data$color) + theme(legend.position = "none", legend.text = element_text(size = 7)) + ggtitle("")

p2 <- ggplot(celltype_cluster_data, aes(x = Var1, y = Freq, fill = Var1)) +
  geom_bar(stat = "identity") +
  theme_minimal() +
  scale_fill_manual(values = celltype_cluster_data$color) +
  coord_flip() +
  theme(
    legend.position = "none",
    axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1),
...
DotPlot(seurat_object, features = interleukins.diffexpr, group.by = "predicted.id.Cell_type_nicknames", dot.scale = 5) +
  scale_color_gradient2(high = "red", low = "blue") +
  theme(
...
DotPlot(seurat_object, features = interleukins_inflammatory_diffexpr, group.by = "predicted.id.Cell_type_nicknames", dot.scale = 5, idents = inflammatory) +
  scale_color_gradient2(high = "red", low = "blue") +
  theme(
        axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1, size = 13),
    axis.text.y = element_text(size = 13)
...
DotPlot(seurat_object, features = interleukins, group.by = "predicted.id.Cell_type_nicknames", dot.scale = 6) +
  scale_color_gradient2(high = "red", low = "blue") +
  theme(
...
DotPlot(seurat_object, features = interleukins, group.by = "predicted.id.Cell_type_nicknames", dot.scale = 6, idents = inflammatory) +
  scale_color_gradient2(high = "red", low = "blue") +
  theme(
    axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1, size = 12),
    axis.text.y = element_text(size = 20)
...
DotPlot(seurat_object, features = genes.bennet, group.by = "predicted.id.Cell_type_nicknames", dot.scale = 8) +
  scale_color_gradient2(high = "red", low = "blue") +
  theme(
    axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1, size = 12)
  )
...
DotPlot(seurat_object, features = genes.bennet, group.by = "predicted.id.Cell_type_nicknames", dot.scale = 8, idents = inflammatory) +
  scale_color_gradient2(high = "red", low = "blue") +
  theme(
...
DotPlot(seurat_object, features = genes.bennet, group.by = "predicted.id.Cell_type_nicknames", dot.scale = 6) +
  scale_color_gradient2(high = "red", low = "blue") +
  theme(
    axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1, size = 10)
  )
...
```{r, echo=FALSE, fig.align = "center", fig.height = 5, fig.width = 10}
th_cells <- colnames(seurat_object)[which(seurat_object$predicted.id.Cell_type_nicknames %in% c("Th", "Tc", "Treg"))]
