...
obj_merged_08$temp.ident <- "lupus"
obj_merged_08$temp.ident[grep("BF-LE-01-KT", colnames(obj_integr))] <- "psoriasis"
DefaultAssay(obj_merged_08) <- "RNA"
...
DimPlot(obj_merged_08, group.by = "predicted.id.Cell_type_nicknames", label = TRUE) + ggtitle("UMAP of merged psoriatic and reynolds data set, colored by cell types")
```
